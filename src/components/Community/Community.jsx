...
const Community = () => {
  // Generate mock array for community grid (24 items)
  const gridItems = Array.from({ length: 24 });

  return (
    <section className="community-section">
      <div className="container">
        <h2 className="section-title text-center">Our traders community</h2>
        
        <div className="community-grid-wrapper">
          <div className="community-grid">
            {gridItems.map((_, i) => (
               <div key={i} className="community-avatar">
                 <img src={`https://i.pravatar.cc/100?img=${(i % 50) + 1}`} alt="Trader" />
               </div>
            ))}
          </div>
        ...
        <div className="text-center" style={{ marginTop: '3rem', position: 'relative', zIndex: 10 }}>
          <a href="#pricing" className="btn-neon discord-btn" style={{textDecoration: 'none'}}>
